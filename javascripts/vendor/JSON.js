extole.define('JSON', [], function () {
	var t = {};
	var JSON3, JSON;
	var define; // To fool it into thinking there's not a real loader. ...really, these libraries do too much themselves.
	
	// Took out the JSON3 = JSON = {}
	// declaration because the linrary was getting confused
	// wrapped the definition in a function called in the context of "t"
	// so that it suspects this is a browser without JSON at all,
	// so it totally defines it.
...
;(function (window) {
  ...
  if (isLoader) {
	...
	if (t.JSON) {
		...
		throw new Error("JSON not properly defined!");
	}
});